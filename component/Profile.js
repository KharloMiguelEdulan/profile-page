...
const Profile = () => {
  ...
  return (
    <View style={styles.container}>
      <View style={{ justifyContent: 'center',marginLeft: 20, marginTop: 35}}>
      <Avatar />
    </View>
      <View style={styles.header}>
        <Text style={styles.username}>Kharlo Miguel C. Edulan</Text>
        <Text style={styles.status}>Joined 11 Months Ago</Text>
      </View>
